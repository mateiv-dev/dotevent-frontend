  ...
  return (
    ...
    >
      <div className="space-y-8 max-w-5xl mx-auto">
        <div className={`relative rounded-2xl overflow-hidden bg-gradient-to-br ${getCategoryStyles(event.category).gradient} p-8 md:p-12 text-white shadow-lg`}>
          <div className="relative z-10">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight max-w-3xl">{event.title}</h1>
            <div className="flex flex-wrap gap-6 text-blue-50">
              <div className="flex items-center gap-2">
                <Calendar size={20} />
                <span className="font-medium">{new Date(event.date).toLocaleDateString(undefined, { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric' })}</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock size={20} />
          ...
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <div className="mt-6 p-4 bg-slate-50 rounded-xl border border-slate-100 text-sm text-slate-500">
                <p>Please arrive 15 minutes early for check-in. Don't forget to bring your student ID.</p>
              </div>
            </section>
            ...
            <section className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-bold text-lg text-slate-900">{event.organizer || 'University Board'}</p>
                  <p className="text-slate-500">Contact: events@university.edu</p>
                </div>
              </div>
            </section>
          </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-lg p-6 sticky top-8">
              <div className="mb-6 text-center">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-3xl font-bold text-slate-900">{event.capacity - event.attendees}</span>
                  <span className="text-slate-400 text-lg font-medium">/ {event.capacity} left</span>
                </div>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className={`w-full py-3.5 rounded-xl font-bold text-base transition-all flex items-center justify-center gap-2 shadow-sm hover:shadow-md active:scale-[0.98] ${event.isRegistered
              ...
              {event.isRegistered && (
                <div className="mt-6 p-4 bg-green-50 border border-green-100 rounded-xl flex gap-3 items-start">
                  ...
                  <div className="text-xs text-green-800">
                    ...
                    <p>A confirmation email has been sent to your student inbox.</p>
                  </div>
                </div>
              )}
            </div>
